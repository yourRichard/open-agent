...
ScrollReveal().reveal(".aii3" ,{ delay:500, origin:'right' });
...
ScrollReveal().reveal(".AI-1" ,{ delay:300, origin:'left' });
ScrollReveal().reveal(".AI-2" ,{ delay:300, origin:'right' });
ScrollReveal().reveal(".contact-img-con" ,{ delay:300, origin:'top' });
